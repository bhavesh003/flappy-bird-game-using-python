...
game_image = {}
game_audio_sound = {}
player = 'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/bird.png'
bcg_image = 'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/background.png'
pipe_image = 'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/pipe.png'
        ...
        for event in pygame.event.get():
            ...
            # If the user presses space or up key, start the game for them
                ...
                display_screen_window.blit(
                    game_image['base'], (b_x, play_ground))
...
def main_gameplay():
    ...
    while True:
        ...
        for pipe in up_pips:
            pip_middle_positions = pipe['x'] + \
                game_image['pipe'][0].get_width() / 2
        ...
        for pip_upper, pip_lower in zip(up_pips, low_pips):
            display_screen_window.blit(
                game_image['pipe'][0], (pip_upper['x'], pip_upper['y']))
            display_screen_window.blit(
                game_image['pipe'][1], (pip_lower['x'], pip_lower['y']))
...
if __name__ == "__main__":
    ...
    game_image['numbers'] = (
        pygame.image.load(
            'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/0.png').convert_alpha(),
        pygame.image.load(
            'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/1.png').convert_alpha(),
        pygame.image.load(
            'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/2.png').convert_alpha(),
        pygame.image.load(
            'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/3.png').convert_alpha(),
        pygame.image.load(
            'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/4.png').convert_alpha(),
        pygame.image.load(
            'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/5.png').convert_alpha(),
        pygame.image.load(
            'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/6.png').convert_alpha(),
        pygame.image.load(
            'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/7.png').convert_alpha(),
        pygame.image.load(
            'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/8.png').convert_alpha(),
        pygame.image.load(
            'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/9.png').convert_alpha(),
    )

    game_image['message'] = pygame.image.load(
        'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/message.png').convert_alpha()
    game_image['base'] = pygame.image.load(
        'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\images/base.png').convert_alpha()
    ...
    # Game sounds
    game_audio_sound['die'] = pygame.mixer.Sound(
        'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\sounds/die.wav')
    game_audio_sound['hit'] = pygame.mixer.Sound(
        'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\sounds/hit.wav')
    game_audio_sound['point'] = pygame.mixer.Sound(
        'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\sounds/point.wav')
    game_audio_sound['swoosh'] = pygame.mixer.Sound(
        'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\sounds/swoosh.wav')
    game_audio_sound['wing'] = pygame.mixer.Sound(
        'F:\Code Playground\Projects\Python Projects\Flappy Birds Game\sounds/wing.wav')
